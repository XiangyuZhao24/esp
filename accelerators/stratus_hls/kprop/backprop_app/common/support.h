//This file defines Array read and write functions, STAC(translation from type to its R/W functions), and PRNG(random generator)
//Per-benchmark functions(run_benchmark and so on) also defined. For backprop specific, search for local_support.c 
#include <stdlib.h>
#include <inttypes.h>
...
///// TYPE macros
// Macro trick to automatically expand TYPE into the appropriate function (Read/Write functions above)
